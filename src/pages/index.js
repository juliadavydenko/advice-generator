    ...
    >
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          Unlock the power of expert guidance at your fingertips with
          GuidanceGenius - the ultimate advice-generator app. Whether you're
          seeking words of wisdom, practical tips, or a fresh perspective on
          life's challenges, our app delivers personalized and insightful advice
          tailored just for you. Embrace the convenience of instant inspiration
          and make confident decisions with the help of GuidanceGenius. Elevate
          your journey towards success, happiness, and fulfillment, one piece of
          expert advice at a time.
